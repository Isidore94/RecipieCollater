...
| D5 | Claude API only — Haiku extraction, Sonnet chat; structured outputs; spend cap + usage log; no local LLM | Local generation measured non-viable (~1 tok/s w/ context); $3–8/month realistic |
